...
function Timeliner(target, containerElement) {
	if (!containerElement) {
		throw new Error("Timeliner requires a valid container element")
	}
	...
	*/
	...
	top_right_bar.id = "top_right_bar"
