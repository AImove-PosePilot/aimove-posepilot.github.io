...
function LayerCabinet(data, dispatcher) {
	...
	operations_div.id = "operations_div"
	...
	*/
	...
	function convertPercentToTime(t) {
		...
		var max_time = 1
		var v =
			(LayoutConstants.width * 0.8) / (t * (max_time - min_time) + min_time)
		return v
	}
	...
	function convertTimeToPercent(v) {
		...
		var max_time = 1
		var t =
			((LayoutConstants.width * 0.8) / v - min_time) / (max_time - min_time)
		return t
	}
